...
Version 0.8 · 19 September 2026 · Aligned to the current interactive prototype
...
The Markdown files in this folder are canonical. The generated [HTML reading copies](../output/htlm/README.html) are refreshed from them for review; the PDF executive edition is a separate concise summary, not the product specification.
...
## Current prototype alignment — 19 September 2026
...
The same prototype demonstrates a worklist, person/care-period context, collection through sample SMS, tablet and clinician-entry paths, purpose-specific consent requests with accept/decline/withdraw history, channel-dependent review handling, correction history, follow-up planning, pause/close actions, a provisional Events tab and instrument administration. **Report** now opens a selected-episode **Care timeline**. It can filter the visible tracks to All, Care, Context and (where present) K10; dated care periods, medication courses, recorded events, goal milestones, risk-related events and complete K10 responses can be selected for source detail. The fixture record Jordan Ellis also exposes additional hard-coded visual experiments for design review. They are fictional examples, not a reusable reporting contract or governed care data.

The Report does not currently render the earlier questionnaire dashboard, normalised Likert aggregate, questionnaire comparison, clinician narrative or report-change log. Assessment and History remain the source surfaces for collections, response/review history and changes. Timeline markers show record timing only; they do not establish influence, causality, risk, treatment effect or clinical direction. Its sample rule marks clinician entry and supported tablet completion **Review not required** while SMS and independent tablet responses remain pending review. It uses browser-local storage, fictional people, sample policy/content and local role checks only. A hosted prototype still does **not** prove identity/authority, production authentication or authorisation, external referral/SMS/consent delivery, multi-user concurrency, clinical instruments/scoring, approved consent/review policy, or release readiness. The [current longitudinal Report status](prototype-longitudinal-report-status-2026-09-19.md) records the exact local behaviour. The [requirements contract](05-requirements-and-logic.md#7-intake-and-onward-referral-contract), F-01/F-10/F-17, ST-11/ST-27–ST-31 and the AC catalogue remain the intended specification; D-04–D-10, D-26–D-29 retain remaining policy, clinical and service decisions. Report and Events are explicitly provisional and require stakeholder validation before production sign-off.
...
The supplied persona PDF expands the product horizon beyond collection to service improvement and system evidence. Its Stage 2 self-report statement conflicts with the captured Slack MVP requirement; D-21 tracks that conflict. The staff longitudinal Report is current prototype evidence only; participant progress access, centre/service dashboards, wider care recording, reporting, integration, and research remain visible candidate scope (CR-01–CR-08), not hidden omissions or new launch commitments.
