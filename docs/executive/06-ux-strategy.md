...
## Optimise for understanding, not just speed.

Reduce avoidable effort while keeping participation informed, records trustworthy and the next action clear.
...
Basis: Detailed brief 06, principles, priorities, content and accessibility; FR-41 proposes WCAG 2.2 AA as a target.
...
| --- | --- |
| Participation and understanding | Baseline/follow-up fulfilment, teach-back and assistance; distinguish permitted skips, pauses and declines. |
| Effort and continuity | Comparable staff task time, intake-to-core completion and owned next actions; report open/incomplete work. |
| Integrity and recovery | Complete correction audit and recovery without loss, false success, duplicate fulfilment or access leakage. |

### No invented targets or timeline
