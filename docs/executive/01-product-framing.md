...
Keep reported capabilities, proposed delivery scope and broader ambitions visibly separate.
...
Oli's captured Slack message reports direct person/family collection in MVP. The persona PDF places direct self-report in Stage 2 and a person dashboard in MVP. Neither conflict is resolved by this executive edition. D-21.

| DECISION | OWNER NEEDED |
| --- | --- |
| Confirm core assessment and clinical rules | Caroline + clinical/content leads |
