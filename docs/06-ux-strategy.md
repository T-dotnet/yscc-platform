...
With Jess, Tom, Ananya, Rachel, Sam, and supporting facilitator/administrator capabilities, collect the words and task groupings staff use. Test “Assessment,” “Measures,” “Consent and respondents,” and “Data quality.” Separately investigate care, fidelity, and reporting vocabulary; the source's three persona groups are an actor model, not automatically three navigation labels.
...
- For the staff Progress tab, lead with a clinician-editable questionnaire report: summary, changes over time, interpretation and next steps. Keep dated source evidence available, and disclose individual answer comparisons on demand. Preserve report versions and flag new evidence for review.
